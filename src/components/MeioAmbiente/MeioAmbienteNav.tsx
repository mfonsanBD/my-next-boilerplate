...
const menuItems: Items[] = [
  { label: 'Obras Embargadas', url: '/meio-ambiente/obras-embargadas' },
  { label: 'Responsáveis de Obras', url: '/meio-ambiente/responsaveis-obras' },
]

export function MeioAmbienteNav() {
