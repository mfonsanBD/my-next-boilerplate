...
const menuItems: Items[] = [
  { label: 'Permissionários Táxi', url: '#' },
  { label: 'Permissionários Van', url: '/transporte/permissionario-van' },
  { label: 'Permissionários Turismo', url: '#' },
  { label: 'Permissionários Bugre', url: '#' },
  { label: 'Cadastro TAPP', url: '#' },
  { label: 'Motorista Aux. Táxi', url: '#' },
  { label: 'Motorista Aux. Van', url: '#' },
  { label: 'Cartão Especial', url: '#' },
  { label: 'Idoso/PNE', url: '#' },
  { label: 'Apreensões', url: '#' },
  { label: 'Processos ADM/AIF', url: '#' },
  { label: 'Notificações', url: '#' },
  { label: 'Auto de Infrações', url: '#' },
]
